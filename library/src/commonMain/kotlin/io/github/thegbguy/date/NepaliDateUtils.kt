...
import io.github.thegbguy.library.generated.resources.*
...
object NepaliDateUtils {
    ...
    internal val daysInMonthMap: HashMap<Int, IntArray> = setDaysInMonthMap()
    internal val startWeekDayMonthMap: HashMap<Int, IntArray> = setStartWeekDayMonthMap()

    private fun setDaysInMonthMap(): HashMap<Int, IntArray> {
        val daysInMonthMap: HashMap<Int, IntArray> = HashMap()
        ...
        daysInMonthMap.put(2081, intArrayOf(0, 31, 32, 32, 32, 31, 30, 30, 30, 29, 30, 30, 30))
    ...
    private fun setStartWeekDayMonthMap(): HashMap<Int, IntArray> {
        val startWeekDayMonthMap: HashMap<Int, IntArray> = HashMap()
    ...
    fun getDayOfWeek(week: Int?): String {
        when (week) {
            1 -> return stringResource(Res.string.weekday_1)
            2 -> return stringResource(Res.string.weekday_2)
            3 -> return stringResource(Res.string.weekday_3)
            4 -> return stringResource(Res.string.weekday_4)
            5 -> return stringResource(Res.string.weekday_5)
            6 -> return stringResource(Res.string.weekday_6)
            7 -> return stringResource(Res.string.weekday_7)
        }
        return ""
    }
    ...
    fun getShortDayOfWeek(week: Int?): String {
        when (week) {
            1 -> return stringResource(Res.string.weekday_1_short)
            2 -> return stringResource(Res.string.weekday_2_short)
            3 -> return stringResource(Res.string.weekday_3_short)
            4 -> return stringResource(Res.string.weekday_4_short)
            5 -> return stringResource(Res.string.weekday_5_short)
            6 -> return stringResource(Res.string.weekday_6_short)
            7 -> return stringResource(Res.string.weekday_7_short)
        }
        return ""
    }
    ...
    fun getFullDayOfWeek(week: Int?): String {
        when (week) {
            1 -> return stringResource(Res.string.weekday_1_full)
            2 -> return stringResource(Res.string.weekday_2_full)
            3 -> return stringResource(Res.string.weekday_3_full)
            4 -> return stringResource(Res.string.weekday_4_full)
            5 -> return stringResource(Res.string.weekday_5_full)
            6 -> return stringResource(Res.string.weekday_6_full)
            7 -> return stringResource(Res.string.weekday_7_full)
        }
        return ""
    }
    ...
    fun getNepaliMonthString(month: Int): String {
        when (month) {
            1 -> return stringResource(Res.string.baisakh)
            2 -> return stringResource(Res.string.jestha)
            3 -> return stringResource(Res.string.ashar)
            4 -> return stringResource(Res.string.shrawan)
            5 -> return stringResource(Res.string.bhadra)
            6 -> return stringResource(Res.string.ashoj)
            7 -> return stringResource(Res.string.kartik)
            8 -> return stringResource(Res.string.mangsir)
            9 -> return stringResource(Res.string.poush)
            10 -> return stringResource(Res.string.magh)
            11 -> return stringResource(Res.string.falgun)
            12 -> return stringResource(Res.string.chaitra)
        }
        return ""
    }
    ...
    fun fillMissingWeekDayValue(nepaliDate: NepaliDate): NepaliDate {
        var startWeekDay =
            startWeekDayMonthMap.get(nepaliDate.year)?.getOrNull(nepaliDate.month) ?: return nepaliDate
...
//    @Contract(pure = true)
    ...
    fun adToBs(date: LocalDate): NepaliDate {
        return convertToBs(
    ...
    fun bsToAd(yy: Int, mm: Int, dd: Int): LocalDate {
