...
import io.github.thegbguy.utils.NpDateColor
import io.github.thegbguy.utils.NpDateColor.disabledTextColor
import io.github.thegbguy.utils.NpDateColor.selectedTextColor
...
internal fun DayOfWeekViewItem(text: String) {
    Text(
        ...
        color = textColor(),
        modifier = Modifier
            .width(getScreenSizeInfo().wDP / WEIGHT_DAY_VIEW_MONTH)
